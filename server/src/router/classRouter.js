...
router.post('/v1/invite-student/:userRole/:teacherId/:studentId/:classId', verifyToken, ClassController.inviteStudent)
router.put('/v1/accept-invite/:userRole/:studentId/:classId', verifyToken, ClassController.acceptInvite)
router.delete('/v1/reject-invite/:userRole/:studentId/:classId', verifyToken, ClassController.rejectInvite)
